...
#     return render(request, 'productapp/profile.html', {'categories': categories})
...
#     return render(request, 'productapp/notice.html', context)
...
#     return render(request, 'productapp/notice_detail.html', context)
...
#     return render(request, 'productapp/order_list.html', context)
...
#             cart.delete()
#             return redirect('productapp:cart', user.pk)
...
#                 order.save()
#                 return redirect('productapp:order_list', user.pk)
